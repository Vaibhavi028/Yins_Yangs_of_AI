...
const items= [
  ...
  },
  {
      ...
      description:'Artificial intelligence is changing every aspect of life and helps solve complex problems with its many application. In today’s world, there is no need for evidence to support the dissemination of intelligence. With the help of AI business owners can find leads, create content, and track sales. Partnerships with intelligence can help marketers, individuals, and advertising organizations increase the effectiveness of marketing campaigns. At the same time, machine learning models, advanced analytical tools and deep learning network algorithms manage to increase the benefits of using social intelligence. The potential and popularity of AI is increasing. Artificial Intelligence has grown tremendously in the last few years and has application in almost every industry/field. The reach of AI has spread to all areas of life , but its application in the business world has also become deeper. Over the years ,influncer, content creators and audiences have witnessed rapid change. For social media user, now is the best time to witness the further growth of this industry. AI has widened its reach in all the fields of life, but has made its way deeper in the marketing sector. ',
